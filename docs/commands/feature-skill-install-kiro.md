...
# dev feature-skill-install-kiro

Install the feature skill for Kiro and initialize project context
...
Interactively install the feature skill for Kiro (global or project steering) and initialize the project context structure.
