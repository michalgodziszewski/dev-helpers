...
Read Base Branch, Jira Ticket, ordered Published Commits, and optional backport metadata from the selected item. Accept legacy singular commit fields only after confirmation.
